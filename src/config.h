...
/* Build platform */
#define BUILD_BUILD_PLATFORM "x86_64-unknown-linux-gnu"

/* Compiler */
#define BUILD_COMPILER "gcc version 5.4.0 20160609 (Ubuntu 5.4.0-6ubuntu1~16.04.4) "

/* Configure arguments */
#define BUILD_CONFIGURE_ARGS ""

/* Build date */
#define BUILD_DATE "Fri Mar 10 15:30:47 EST 2017"

/* Build host */
#define BUILD_HOST "athlon"

/* Host platform */
#define BUILD_HOST_PLATFORM "x86_64-unknown-linux-gnu"

/* Target platform */
#define BUILD_TARGET_PLATFORM "x86_64-unknown-linux-gnu"

/* Build user */
#define BUILD_USER "keith"
...
#define FLARQ_BUILD_CXXFLAGS "-I$(srcdir) -I$(srcdir)/include -I$(srcdir)/fileselector -I$(srcdir)/flarq-src -I$(srcdir)/flarq-src/include -I$(srcdir)/xmlrpcpp -I/usr/include/cairo -I/usr/include/glib-2.0 -I/usr/lib/x86_64-linux-gnu/glib-2.0/include -I/usr/include/pixman-1 -I/usr/include/freetype2 -I/usr/include/libpng12 -I/usr/include/freetype2 -I/usr/include/cairo -I/usr/include/glib-2.0 -I/usr/lib/x86_64-linux-gnu/glib-2.0/include -I/usr/include/pixman-1 -I/usr/include/freetype2 -I/usr/include/libpng12 -fvisibility-inlines-hidden -D_LARGEFILE_SOURCE -D_LARGEFILE64_SOURCE -D_THREAD_SAFE -D_REENTRANT -pipe -Wall -fexceptions -O2 -I$(srcdir)/xmlrpcpp -DNDEBUG"

/* Flarq linker flags */
#define FLARQ_BUILD_LDFLAGS "-Wl,-Bsymbolic-functions -lfltk_images -lfltk -lX11 -lX11 -ldl -lpthread"
...
#define FLDIGI_BUILD_CXXFLAGS "-I$(srcdir) -I$(srcdir)/include -I$(srcdir)/irrxml -I$(srcdir)/libtiniconv -I$(srcdir)/fileselector -I$(srcdir)/xmlrpcpp -pthread -I/usr/include/cairo -I/usr/include/glib-2.0 -I/usr/lib/x86_64-linux-gnu/glib-2.0/include -I/usr/include/pixman-1 -I/usr/include/freetype2 -I/usr/include/libpng12 -I/usr/include/freetype2 -I/usr/include/cairo -I/usr/include/glib-2.0 -I/usr/lib/x86_64-linux-gnu/glib-2.0/include -I/usr/include/pixman-1 -I/usr/include/freetype2 -I/usr/include/libpng12 -fvisibility-inlines-hidden -D_LARGEFILE_SOURCE -D_LARGEFILE64_SOURCE -D_THREAD_SAFE -D_REENTRANT -D_REENTRANT -I/usr/include/libpng12 -pipe -Wall -fexceptions -O2 --param=max-vartrack-size=0 -I$(srcdir)/xmlrpcpp --param=max-vartrack-size=0 -DNDEBUG"

/* Fldigi linker flags */
#define FLDIGI_BUILD_LDFLAGS "-lportaudio -lasound -lm -lpthread -Wl,-Bsymbolic-functions -lfltk_images -lfltk -lX11 -lX11 -lsamplerate -lpulse-simple -lpulse -lpng12 -ldl -lpthread"
...
/* FLTK API patch */
#define FLDIGI_FLTK_API_PATCH 3

/* Fldigi version string */
#define FLDIGI_VERSION "4.0.0.1"
...
#define FLDIGI_VERSION_PATCH ".0.1"

/* FLTK version */
#define FLTK_BUILD_VERSION "1.3.3"
...
#define PACKAGE_STRING "fldigi 4.0.0.1"
...
#define PACKAGE_VERSION "4.0.0.1"

/* png version */
#define PNG_BUILD_VERSION "1.2.54"

/* portaudio version */
#define PORTAUDIO_BUILD_VERSION "19"

/* pulseaudio version */
#define PULSEAUDIO_BUILD_VERSION "8.0"
